...
class HLI:
    ...
    """
    def __init__(self, opcode:Opcode, dst:MemOperand=None, src1:Operand=None, src2:Operand=None):
    ...
    def __str__(self):
        ...
        return str(self.opcode) + " " + str(self.dst) + ", " + str(self.src1) + src2_str
...
class MLMI:
    ...
    def FromHLI(hli:HLI):
        ...
        inputs =  [ src for src in [hli.src1, hli.src2] if isinstance(src,MemOperand) ]
        outputs = [ hli.dst ]
...
class LLI:
    ...
    """
    def __init__(self, opcode:Opcode, dst:RegOperand=None, src1:Operand=None, src2:Operand=None):
        self.opcode : Final = opcode
        self.dst    : Final = dst
        self.src1   : Final = src1
        self.src2   : Final = src2
