...
for my $uni (qw(uni no_uni)) {
    for my $cipher (qw(AES Ascon Photon TinyJambu)) {
        for my $size (qw(tiny small medium large)) {
...
\\multirow{4}{*}{AES}       & tiny   &   \\multirow{4}{*}{%s}    &    %s     &    %s     &         %s          &             %s            &      %s        &        %s        \\\\
                            & small  &                           &    %s     &    %s     &         %s          &             %s            &      %s        &        %s        \\\\
                            & medium &                           &    %s     &    %s     &         %s          &             %s            &      %s        &        %s        \\\\
                            & large  &                           &    %s     &    %s     &         %s          &             %s            &      %s        &        %s        \\\\
\\hline
\\multirow{4}{*}{Ascon}     & tiny   &   \\multirow{4}{*}{%s}    &    %s     &    %s     &         %s          &             %s            &      %s        &        %s        \\\\
                            & small  &                           &    %s     &    %s     &         %s          &             %s            &      %s        &        %s        \\\\
                            & medium &                           &    %s     &    %s     &         %s          &             %s            &      %s        &        %s        \\\\
                            & large  &                           &    %s     &    %s     &         %s          &             %s            &      %s        &        %s        \\\\
\\hline
\\multirow{4}{*}{Photon}    & tiny   &   \\multirow{4}{*}{%s}    &    %s     &    %s     &         %s          &             %s            &      %s        &        %s        \\\\
                            & small  &                           &    %s     &    %s     &         %s          &             %s            &      %s        &        %s        \\\\
                            & medium &                           &    %s     &    %s     &         %s          &             %s            &      %s        &        %s        \\\\
                            & large  &                           &    %s     &    %s     &         %s          &             %s            &      %s        &        %s        \\\\
\\hline
\\multirow{4}{*}{TinyJAMBU} & tiny   &   \\multirow{4}{*}{%s}    &    %s     &    %s     &         %s          &             %s            &      %s        &        %s        \\\\
                            & small  &                           &    %s     &    %s     &         %s          &             %s            &      %s        &        %s        \\\\
                            & medium &                           &    %s     &    %s     &         %s          &             %s            &      %s        &        %s        \\\\
                            & large  &                           &    %s     &    %s     &         %s          &             %s            &      %s        &        %s        \\\\
',
    map { my $cipher = $_;
          ...
          qw(tiny small medium large)
        } qw(AES Ascon Photon TinyJambu);
...
\\hline
\\multirow{4}{*}{AES}       & tiny                       &   \\multirow{4}{*}{%s}   &           %s                &       %s                     \\\\
                           & small                       &      &           %s                &       %s                     \\\\
                           & medium                      &      &           %s                &       %s                     \\\\
                           & large                       &      &           %s                &       %s                     \\\\
\\hline
\\multirow{4}{*}{Ascon}     & tiny                       &   \\multirow{4}{*}{%s}   &           %s                &       %s                     \\\\
                           & small                       &      &           %s                &       %s                     \\\\
                           & medium                      &      &           %s                &       %s                     \\\\
                           & large                       &      &           %s                &       %s                     \\\\
\\hline
\\multirow{4}{*}{Photon}    & tiny                       &   \\multirow{4}{*}{%s}   &           %s                &       %s                     \\\\
                           & small                       &      &           %s                &       %s                     \\\\
                           & medium                      &      &           %s                &       %s                     \\\\
                           & large                       &      &           %s                &       %s                     \\\\
\\hline
\\multirow{4}{*}{TinyJAMBU} & tiny                       &   \\multirow{4}{*}{%s}   &           %s                &       %s                     \\\\
                           & small                       &      &           %s                &       %s                     \\\\
                           & medium                      &      &           %s                &       %s                     \\\\
                           & large                       &      &           %s                &       %s                     \\\\
',
